...
public class PolicyDescriptor {
    ...
    public PolicyDescriptor(String policy_id, String location_id, Boolean is_enabled, Boolean presence_mode, String start_working_time, String end_working_time, Integer max_persons) {
